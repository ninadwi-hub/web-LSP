          ...
          <li><a class="nav-link scrollto " href="#hero">Home</a></li>
           <li class="dropdown"><a href="#"><span>Profil</span> <i class="bi bi-chevron-down"></i></a>
            <ul>
              ...
              <li><a href="#">Wewenang Tugas dan Fungsi</a></li>
              <li><a href="#">Tugas Pokok Personal</a></li>
...
<section class="py-5 bg-light">
    <div class="container text-center">
        ...
        {{-- Gambar besar --}}
        <img src="{{ asset('/THEMES/Medicio/assets/img/sejarah-visi.png') }}" alt="Sejarah Visi Misi" class="img-fluid rounded shadow-sm" style="max-width: 700px;">
    </div>
</section>
